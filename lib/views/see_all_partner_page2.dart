...
import 'package:tamang_food_service_food_ordering_app/provider/see_all_partner_page2_provider.dart';

class SeeAllPartnerPage2 extends StatelessWidget {
  const SeeAllPartnerPage2({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => SeeAllPartnerPage2Provider(),
      child: Scaffold(
        body: Column(
          children: [
            ...
            SizedBox(height: 20),
        Consumer<SeeAllPartnerPage2Provider>(
        ...
        SizedBox(height: 10),
            Expanded(
              child: Padding(
                ...
                child: Consumer<SeeAllPartnerPage2Provider>(
                  builder: (context, provider, child) {
